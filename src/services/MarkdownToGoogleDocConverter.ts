...
export class MarkdownToGoogleDocConverter {
    ...
    private static processLine(lines: string[], index: number): { element: docs_v1.Schema$StructuralElement | null, nextIndex: number } {
    ...
    private static processList(lines: string[], startIndex: number, isNumbered: boolean): { element: docs_v1.Schema$StructuralElement | null, nextIndex: number } {
    ...
    private static processTable(lines: string[], startIndex: number): { element: docs_v1.Schema$StructuralElement | null, nextIndex: number } {
        const tableLines = [];
        let i = startIndex;
    ...
    private static createListItem(text: string, indent: number, isNumbered: boolean): docs_v1.Schema$StructuralElement {
        const elements = this.parseInlineFormatting(text);
    ...
    private static parseBasicFormatting(text: string): { text: string, style: docs_v1.Schema$TextStyle }[] {
        ...
        const replacements: { start: number, end: number, replacement: string, style: docs_v1.Schema$TextStyle }[] = [];
